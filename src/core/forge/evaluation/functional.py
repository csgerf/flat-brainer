...
def focal_loss_with_logits(
    ...
    Args:
        ...
        ignore_index: If not None, targets with given index are ignored
        softmax_dim: Dimension along which softmax will be computed. Default is None.
...
def softmax_focal_loss_with_logits(
    ...
    Args:
        ...
        ignore_index: Label that should be ignored during the loss computation
    """
