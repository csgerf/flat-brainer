...
class Isocortex2dProjector:
    ...
    def __init__(self,
                 projection_file: OnePath,
                 surface_paths_file: OnePath,
                 hemisphere: str = "both",
                 view_space_for_other_hemisphere: Union[bool, str, int] = False,
                 ):
    ...
    def _load_and_sort_paths(self, surface_paths_file: OnePath) -> Tuple[np.ndarray, np.ndarray]:
    ...
    def project_volume(self, volume: np.ndarray, kind: str = "max") -> np.ndarray:
    ...
    def _project_volume_to_view(self, volume: np.ndarray, kind: str = "max") -> np.ndarray:
    ...
    def project_path_ordered_data(self, data: np.ndarray) -> np.ndarray:
...
class Isocortex3dProjector(Isocortex2dProjector):
    ...
    def __init__(self,
                 ...
                 streamline_layer_thickness_file: Optional[OnePath] = None,
                 hemisphere: str = "both",
                 view_space_for_other_hemisphere: Union[bool, str, int] = False,
                 ):
        super().__init__(
    ...
    def project_volume(self, volume: np.ndarray, thickness_type=None) -> np.ndarray:
    ...
    def _project_volume_unnormalized(self, volume: np.ndarray) -> np.ndarray:
    ...
    def _project_volume_normalized_full(self, volume: np.ndarray) -> np.ndarray:
    ...
    def _project_volume_normalized_layers(self, volume: np.ndarray) -> np.ndarray:
    ...
    def reference_layer_thicknesses_in_voxels(self) -> Dict:
...
class BoundaryFinder:
    ...
    def __init__(self,
                 projected_atlas_file: OnePath,
                 labels_file: OnePath,
                 single_hemisphere: bool = True,
                 ):
    ...
    def region_boundaries(self,
                          ...
                          hemisphere: str = "left",
                          view_space_for_other_hemisphere: Union[bool, str] = False) -> Dict:
    ...
    def _validate_inputs(self,
                         region_acronyms: Optional[List[str]],
                         hemisphere: str,
                         view_space_for_other_hemisphere: bool) -> Tuple[List[str], str, bool]:
...
class IsocortexCoordinateProjector:
    ...
    def __init__(self,
                 surface_paths_file: OnePath,
                 closest_surface_voxel_reference_file: OnePath,
                 layer_thicknesses: Optional[List[str]] = None,
                 streamline_layer_thickness_file: Optional[OnePath] = None,
                 resolution: Tuple[int, int, int] = (10, 10, 10),
                 projection_file: Optional[OnePath] = None):
    ...
    def project_coordinates(self,
        ...
        reflect_coords, voxels, orig_voxels, matching_surface_voxel_ind = self._get_collapsed_voxels_and_surface_voxels(
            coords)
    ...
    def project_depths(self, coords: np.ndarray, thickness_type: str = 'unnormalized',
                       scale: str = 'voxels') -> np.ndarray:
        ...
        return self._calculate_depths(reflect_coords, voxels, matching_surface_voxel_ind, thickness_type=thickness_type,
                                      scale=scale)

    def _calculate_depths(self, coords: np.ndarray, voxels: np.ndarray, matching_surface_voxel_ind, thickness_type: str ='normalized_layers',
                          scale: str = 'voxels'):
    ...
    def _get_collapsed_voxels_and_surface_voxels(self, coords):
        ...
        reflect_coords[reflect_coords[:, 2] > z_midline * self.resolution[2], 2] = z_size * self.resolution[2] - \
                                                                                   reflect_coords[reflect_coords[:,
                                                                                                  2] > z_midline *
                                                                                                  self.resolution[2], 2]
...
class IsocortexEntireProjector:
    ...
    def top_of_streamline_coords(self, scale: str ='voxels'):
